...
namespace GCAL.Base
{
    public class GPTimeZone
    {
        ...
        {
            public const int RULE_WEEK_OF_MONTH = 0;
            public const int RULE_DAY_OF_MONTH = 1;

            public int RuleType = 0;

            public int domDay = 1;
            public int domMonth = 4;
            
            public int womDayOfWeek = 0;
            public int womWeekOfMonth = 5;
            public int womMonth = 3;
        ...
        public string SymbolLocalTime = string.Empty;
        public string SymbolDaylightTime = string.Empty;
